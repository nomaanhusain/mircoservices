...
public class CurrencyConversionController {
	...
	//it just makes code eaiser and more readable as in above function we can see so many lines are required to call rest api
	//moreover this also helps adding naming server and load balancing
